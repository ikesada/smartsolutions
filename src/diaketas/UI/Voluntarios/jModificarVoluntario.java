 ...
 //           boolean exito=true;
            ...
            if( continuar )   //si todos los datos introducidos son correctos, llamo a las funciones
            {
                ...
                if(existe_vol)
                {
                    ...
                    /*exito = */Gestor_de_voluntarios.modificarVoluntario( (String)Nombre.getText(), (String)Apellidos.getText(), (String)NIF.getText().toUpperCase(), telefonoPasado, (String)Domicilio.getText(), (String)Poblacion.getText(), (String)Email.getText(), (String)Nacionalidad.getText(), Fecha_Nac, Integer.parseInt(CodPost.getText()), (String)Obs.getText(), (String)NIF1.getText().toUpperCase() );
